"use strict";
const calculateTriangle = (side1, side2, sideBase, height) => {
...
const calculateHeightTriangle = (sides, sideBase) => {
    if (sides === sideBase) {
...
const calculateHeightAnyoneTriangle = (side1, side2, sideBase) => {
