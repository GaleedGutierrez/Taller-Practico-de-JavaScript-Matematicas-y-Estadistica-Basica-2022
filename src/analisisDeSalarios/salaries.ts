import { InterfaceSalaries } from './interfaces';
...
// ID: 9, NAME: 'Daniela'
// ID: 10, NAME: 'Daniel'
// ID: 11, NAME: 'Rigoberto'
// ID: 12, NAME: 'Alicia'
// ID: 13, NAME: 'Teodoro'
// ID: 14, NAME: 'Bruce'
// ID: 15, NAME: 'Alfred'
// ID: 16, NAME: 'Clark Kent'
// ID: 17, NAME: 'Lois Lane'
// ID: 18, NAME: 'Jimmy Olsen'
// ID: 19, NAME: 'Perry White'
// ID: 20, NAME: 'Lex Luthor'
export const SALARIES: InterfaceSalaries[] = [];
